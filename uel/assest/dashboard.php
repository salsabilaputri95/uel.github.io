...
if ($result) {
    $reservasiData = $result->fetchAll(PDO::FETCH_ASSOC);
} else {
    echo "Error: " . $sql . "<br>";
            ...
            <tbody>
             <?php
                foreach ($reservasiData as $reservasi) {
                    ...
                    echo "<td><a href='edit.php?id=" . $reservasi['nama'] . "'>Edit</a></td>";
                    echo "<td><a href='hapus.php?id=" . $reservasi['nama'] . "'>Delete</a></td>";
